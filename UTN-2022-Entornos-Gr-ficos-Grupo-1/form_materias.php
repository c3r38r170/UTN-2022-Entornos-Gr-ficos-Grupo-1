...
<div class="formulario">
	<form action="controladores/materias.php" method="post">
		...
		<div class="formulario_contenedor">
			...
			<p> Desea cargar la materia en una/varias comisiones?<input type="checkbox" id="myCheck" onclick="functionCheck()"></p>

			<div id="div_select" style="display:none">
				<select name="comisiones[]" multiple>
				<?php require_once 'controladores/comisiones.php';
					$coms = getAllComs();
					foreach ($coms as $ops){
				?>		

					<option value="<?php echo ($ops['id']); ?>"><?php echo ($ops['numero']); ?></option>
